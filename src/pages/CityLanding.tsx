        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-primary hover:bg-primary/80 text-white shadow-neon">
                <Phone className="mr-2 w-5 h-5" /> Jetzt beraten lassen
              </Button>
              <Button size="lg" variant="outline" className="border-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white" asChild>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {city.highlights.map((highlight, i) => (
              <motion.div
                ...
                className="flex items-start gap-3 p-6 rounded-xl border border-white/10 bg-card/40"
              >
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-3xl mx-auto">
            {city.topLocations.map((location) => (
              <span key={location} className="inline-flex items-center gap-2 px-5 py-3 rounded-full border border-white/10 bg-card/40 text-sm hover:border-accent/30 transition-colors">
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center p-12 rounded-2xl border border-primary/30 bg-primary/5">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild className="bg-primary hover:bg-primary/80 text-white shadow-neon">
