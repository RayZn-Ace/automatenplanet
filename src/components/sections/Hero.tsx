...
const Hero = () => {
  return (
    <section className="relative min-h-[40vh] md:min-h-screen flex items-center pt-24 pb-8 md:pt-20 md:pb-0 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-6 break-words"
          >
          ...
          >
            <Button asChild size="lg" className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground shadow-neon h-14 px-8 text-lg rounded-xl">
              <a href="#produkte">
                Automaten entdecken
